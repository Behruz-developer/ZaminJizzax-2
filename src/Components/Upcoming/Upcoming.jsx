                  ...
                  <div className="container">
                    <div className="upcoming_box">
                      <div className="upcoming_card">
                        ...
                        >
                          Har bir kulgi ortida mustahkam
                          barpo etilgan xonadon turadi
                        </h3>
                        <p className="slidet_text2">
                          Zamin Jizzax — musaffo shaharning yuragida qad rostlayotgan komfort toifadagi
                          turar-joy majmuasi. Unda butun oila ahil-inoqlikda yashaydi.
                        </p>
                      </div>
